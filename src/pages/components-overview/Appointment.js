  ...
  const navigate = useNavigate();
    ...
    const handleDelete = (value) => {
        var requestOptions = {
          ...
          fetch(`https://dashboard.weightlossondemand.com/backend/api/delete_apt/${value}`, requestOptions)
    ...
    const getVist = () => {
        axios({
            method: 'get',
            url: 'https://dashboard.weightlossondemand.com/backend/api/all_apt'
        }).then(function (response) {
        ...
        selector: (row) => {
            return (
                <>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" onClick={() => handleClickOpen(row.ap_id)}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
