...
export default function VisitReason() {
  ...
  const navigate = useNavigate();
    ...
    const AddVisitReason = () =>{
        ...
        fetch("https://dashboard.weightlossondemand.com/backend/api/addreason", requestOptions)
        ...
        .then(result => {
            ...
            if(result.status == 200){
                setShow(false)
                setdialog(true)
                setdialogMsg("Reason added successfully!")
            }else{
                setdfield(true)
    ...
    const handleDelete = (value) => {
        var requestOptions = {
          ...
          fetch(`https://dashboard.weightlossondemand.com/backend/api/delete_visitreason/${value}`, requestOptions)
            .then(response => response.json())
            .then(result => {
                console.log(result)
                if(result.status === 200){
    ...
    const getVist = () => {
        axios({
            method: 'get',
            url: 'https://dashboard.weightlossondemand.com/backend/api/visit_reason'
        ...
        selector: (row) => {
            return (
                <>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" onClick={() => handleClickOpen(row.vr_id)}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
    ...
    return (
        <ComponentSkeleton>
            ...
            <Alert  variant="filled" severity='success'>
             ...
             <Button style={textStyles.ibutton}>Add Visit Reason</Button>
            </Link> 
           {/* <Link to={'/slot-add'} style={textStyles.blink}>
            ...
            <Alert  variant="filled" severity='error'>
                {dialogMsg}
                    ...
                    <TextField id="outlined-basic" label="Enter Reason" variant="outlined" style={textStyles.text} value={reason} onChange={e => setreason(e.target.value)}/>
                ...
                <DialogActions>
                <Button onClick={AddVisitReason} style={textStyles.delete}>
                        Add
                    </Button>
