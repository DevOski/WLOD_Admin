...
export default function App_rate() {
  ...
  const navigate = useNavigate();
    ...
    const handleDelete = (value) => {
        var requestOptions = {
          ...
          fetch(`https://dashboard.weightlossondemand.com/backend/api/delete_apprating/${value}`, requestOptions)
    ...
    const getVist = () => {
        axios({
            method: 'get',
            url: 'https://dashboard.weightlossondemand.com/backend/api/app_rate'
        }).then(function (response) {
        ...
        selector: (row) => {
            return (
                <>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" onClick={() => handleClickOpen(row.rate_id)}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
