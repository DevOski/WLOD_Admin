  ...
  const navigate = useNavigate();
    ...
    const handleDelete = (value) => {
        var requestOptions = {
          ...
          fetch(`https://dashboard.weightlossondemand.com/backend/api/tr_delete/${value}`, requestOptions)
    ...
    const getVist = () => {
        axios({
            method: 'get',
            url: 'https://dashboard.weightlossondemand.com/backend/api/alltrainers'
        }).then(function (response) {
        ...
        selector: (row) => {
            return (
                <>
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" onClick={() => handleClickOpen(row.tr_id)}>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
    ...
    return (
        <ComponentSkeleton>
            ...
            <Button style={textStyles.ibutton}>Add Consultant</Button>
            </Link> 
            <Link to={'/slot-add'} style={textStyles.blink}>
            <Button style={textStyles.ibutton}>Add Consultant's Slots</Button>
            </Link>
            <Grid>
